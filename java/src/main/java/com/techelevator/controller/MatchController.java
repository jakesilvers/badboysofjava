...
public class MatchController {
    ...
    public List<List<String>> getMatchesByLeagueID(@PathVariable int leagueID) {
    ...
    @RequestMapping(path = "/api/course/league/matches/user/{userID}", method = RequestMethod.GET)
